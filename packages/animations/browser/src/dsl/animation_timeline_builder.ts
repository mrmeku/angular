...
export function buildAnimationTimelines(
    ...
    finalStyles: ɵStyleData = {}, locals: {[varName: string]: string | number},
...
export class AnimationTimelineContext {
  ...
  subContextCount = 0;
  locals: {[varName: string]: string | number}|undefined;
...
export class AnimationTimelineBuilderVisitor implements AnimationAstVisitor {
  buildKeyframes(
      ...
      locals: {[varName: string]: string | number}, subInstructions?: ElementInstructionMap,
  ...
  private _visitSubInstructions(
      instructions: AnimationTimelineInstruction[], timings: AnimateTimings|undefined,
  ...
  visitReference(ast: AnimationReferenceAst, context: AnimationTimelineContext) {
    ...
    if (defaults) {
      const locals = context.locals = context.locals || {};
...
export class TimelineBuilder {
  ...
  setStyles(
      ...
      errors: any[], locals?: {[varName: string]: string | number}) {
    if (easing) {
